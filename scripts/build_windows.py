#!/usr/bin/env python3
"""
VneEvents Windows Build Script
Copyright (c) 2026 Ajeet Singh Yadav. All rights reserved.
Licensed under the Apache License, Version 2.0 (the "License")

This script builds VneEvents for Windows with Visual Studio integration.
"""
...
def interactive_mode(config: BuildConfig):
    ...
    print("=== VneEvents Interactive Build Configuration ===")
    print()
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Build VneEvents for Windows",
