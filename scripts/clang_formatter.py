...
Examples:
    python scripts/clang_formatter.py src/vneevents
    python scripts/clang_formatter.py src/vneevents --dry-run
    python scripts/clang_formatter.py src/vneevents --verbose
    python scripts/clang_formatter.py --file src/vertexnova/events/events.cpp
    python scripts/clang_formatter.py --file include/vertexnova/events/events.h
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Format C/C++ source files using clang-format with VneEvents rules",
...
Examples:
  ...
  python scripts/clang_formatter.py --file include/vertexnova/events/events.h
    ...
    group.add_argument(
        'folder',
        nargs='?',
        help='Folder path to format (e.g., src/vneevents)'
    )
    group.add_argument(
        '--file',
        help='Specific file to format (e.g., src/vertexnova/events/events.cpp)'
    )
