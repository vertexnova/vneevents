...
Examples:
    python scripts/clang_tidy_analyzer.py src/vneevents
    python scripts/clang_tidy_analyzer.py src/vneevents --verbose
    python scripts/clang_tidy_analyzer.py --file src/vertexnova/events/events.cpp
"""
...
Examples:
  ...
  python scripts/clang_tidy_analyzer.py src/vneevents --save-raw-json
        """
    )
    ...
    print("VneEvents Clang-Tidy Analyzer")
    print("=" * 40)
    print()
