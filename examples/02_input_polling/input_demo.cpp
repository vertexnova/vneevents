...
void InputDemo::demonstrateKeyboardPolling() {
    ...
    VNE_LOG_INFO << "    isKeyPressed(W): "
                 << (vne::events::Input::isKeyPressed(static_cast<int>(vne::events::KeyCode::eW)) ? "true" : "false");
    VNE_LOG_INFO << "    isKeyJustPressed(W): "
                 << (vne::events::Input::isKeyJustPressed(static_cast<int>(vne::events::KeyCode::eW)) ? "true"
                                                                                                      : "false");

    // Press A key
    vne::events::Input::updateKeyState(static_cast<int>(vne::events::KeyCode::eA), true);
    VNE_LOG_INFO << "  A key pressed";
    VNE_LOG_INFO << "    isKeyPressed(A): "
                 << (vne::events::Input::isKeyPressed(static_cast<int>(vne::events::KeyCode::eA)) ? "true" : "false");
    VNE_LOG_INFO << "    isKeyJustPressed(A): "
                 << (vne::events::Input::isKeyJustPressed(static_cast<int>(vne::events::KeyCode::eA)) ? "true"
                                                                                                      : "false");
    ...
    VNE_LOG_INFO << "    isKeyPressed(W): "
                 << (vne::events::Input::isKeyPressed(static_cast<int>(vne::events::KeyCode::eW)) ? "true" : "false");
    VNE_LOG_INFO << "    isKeyJustReleased(W): "
                 << (vne::events::Input::isKeyJustReleased(static_cast<int>(vne::events::KeyCode::eW)) ? "true"
                                                                                                       : "false");
...
void InputDemo::demonstrateMousePolling() {
    ...
    VNE_LOG_INFO << "    isMouseButtonPressed(Left): "
                 << (vne::events::Input::isMouseButtonPressed(static_cast<int>(vne::events::MouseButton::eLeft))
                         ? "true"
                         : "false");
    VNE_LOG_INFO << "    isMouseButtonJustPressed(Left): "
                 << (vne::events::Input::isMouseButtonJustPressed(static_cast<int>(vne::events::MouseButton::eLeft))
                         ? "true"
                         : "false");
    ...
    VNE_LOG_INFO << "    isMouseButtonPressed(Left): "
                 << (vne::events::Input::isMouseButtonPressed(static_cast<int>(vne::events::MouseButton::eLeft))
                         ? "true"
                         : "false");
    VNE_LOG_INFO << "    isMouseButtonJustReleased(Left): "
                 << (vne::events::Input::isMouseButtonJustReleased(static_cast<int>(vne::events::MouseButton::eLeft))
                         ? "true"
                         : "false");
...
void InputDemo::demonstratePerFrameState() {
    ...
    VNE_LOG_INFO << "      isKeyJustPressed(Space): "
                 << (vne::events::Input::isKeyJustPressed(static_cast<int>(vne::events::KeyCode::eSpace)) ? "true"
                                                                                                          : "false");
    VNE_LOG_INFO << "      isKeyPressed(Space): "
                 << (vne::events::Input::isKeyPressed(static_cast<int>(vne::events::KeyCode::eSpace)) ? "true"
                                                                                                      : "false");
    ...
    VNE_LOG_INFO << "      isKeyJustReleased(Space): "
                 << (vne::events::Input::isKeyJustReleased(static_cast<int>(vne::events::KeyCode::eSpace)) ? "true"
                                                                                                           : "false");
