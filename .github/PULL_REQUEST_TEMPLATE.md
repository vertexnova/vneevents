...
- [ ] Project builds (e.g. `cmake -B build/shared/Release` with `-DVNEEVENTS_LIB_TYPE=shared` / `-DBUILD_TESTS=ON` as needed, and `cmake --build`, or a platform script from [scripts/README.md](../scripts/README.md)).
